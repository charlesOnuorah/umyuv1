...
let EditprofilePage = class EditprofilePage {
    constructor(formBuilder, nativeStorage, loadingCtrl, toastController, alertController, platform) {
    ...
    submitStandardHttp(profileForm) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            //usercredentials
            try {
                yield this.nativeStorage.setItem('usercredentials', { User: { username: `${this.user.firstName} ${this.user.lastName}`,
                        firstName: `${this.user.firstName}`,
